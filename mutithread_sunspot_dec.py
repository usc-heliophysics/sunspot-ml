...
def process_images(image_list, scale_factor, max_workers=4):
    with concurrent.futures.ThreadPoolExecutor(max_workers=max_workers) as executor:
        ...
        for image in image_list:
            ...
            future = executor.submit(segment_core, png_path, fits_path, scale_factor)
...
process_images(image_files, scale_factor=2)
